// OBS: Lägg bara till nya frågor längst ned. Ta aldrig bort gamla eller ändra ordning.

export type FAQ = { q: string; a: string };

export const CureviaFAQs: FAQ[] = [
...
export const PinnedFAQs: FAQ[] = [
  CureviaFAQs[0],  // Nenetka AB
  CureviaFAQs[2],  // Är ni bemanningsföretag?
  CureviaFAQs[11], // Vårdgivare registrering
  CureviaFAQs[16], // Hur funkar att jobba via Curevia?
  CureviaFAQs[22], // Nettolön
  CureviaFAQs[28], // Försäkring (vårdgivare)
  CureviaFAQs[40], // Lägga förfrågan
  CureviaFAQs[48], // Logga in
  CureviaFAQs[58], // GDPR
  CureviaFAQs[69]  // Offert
];
